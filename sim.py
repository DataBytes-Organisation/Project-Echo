...
conf = ConnectionConfig(
    MAIL_USERNAME="a9aa3f3c4238a8",  # ✅ check this matches your Mailtrap username
    MAIL_PASSWORD="9e0c4d0323682f",  # ✅ check this matches your Mailtrap password
    MAIL_FROM="no-reply@example.com",  # ✅ valid sender
    MAIL_PORT=587,
