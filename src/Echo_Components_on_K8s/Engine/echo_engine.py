...
class EchoEngine():
    ...
    def __init__(self) -> None:  
        ...
        try:
            ...
            #KUBERNETES TO DO: CHANGE TO INLINE VARIABLES FOR SECURITY
    ...
    def on_message(self, client, userdata, msg):
        ...
        try:   
            ...
            print(audio_event['timestamp'], flush = True)
            ...
            if(audio_event['audioFile'] == "Recording_Mode"): # classic model
                ...
                #KUBERNETES... REFERENCE TO MODEL CONTAINER
    ...
    def echo_api_send_detection_event(self, audio_event, sample_rate, predicted_class, predicted_probability):
        ...
        #KUBERNETES ... Doesn't need to be changed, as the service is named ts-api-cont
    ...
    def execute(self):
        ...
        print(f'Subscribing to MQTT: {self.config["MQTT_CLIENT_URL"]} {self.config["MQTT_PUBLISH_URL"]}', flush=True)
        ...
        if self.class_names is not None:
            ...
            print("Failed to load species list. Check for errors in gcp_load_species_list.", flush=True)

        print("Engine waiting for audio to arrive...", flush=True)
        client.loop_forever()
