...
ONNX_MODEL_PATH = "outputs/2026-01-15/09-23-05/efficientnet_v2_qat.onnx"  # Your existing ONNX model
TF_SAVED_MODEL_PATH = "efficientnet_v2_qat_savedmodel"  # Temporary path for TensorFlow SavedModel
TFLITE_MODEL_PATH = "efficientnet_v2_qat.tflite"  # Output TFLite model
