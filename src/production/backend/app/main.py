from app.middleware.admin_auth import not_in_production
import logging
import os
...
from fastapi import FastAPI, Body, HTTPException, status, APIRouter, Request, Depends
...
@app.get("/openapi-export", include_in_schema=False, dependencies=[Depends(not_in_production)])
...
@app.get("/spec/summary", tags=["debug"], include_in_schema=False, dependencies=[Depends(not_in_production)])
