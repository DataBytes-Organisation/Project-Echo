...
const filter = await import("../../public/features/detections/source-filter.js");
...
test("/map offers All/Simulated/Real-device as segmented buttons", () => {
  const html = fs.readFileSync(new URL("../../public/pages/map/index.html", import.meta.url), "utf8");
...
test("movement markers keep a blank source line while detection markers state theirs", () => {
  ...
  const source = fs.readFileSync(new URL("../../public/features/map/hmi-map.js", import.meta.url), "utf8");
