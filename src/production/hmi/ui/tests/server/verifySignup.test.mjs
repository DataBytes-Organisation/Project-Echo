// First-ever test for server/middleware/verifySignup.js's confirmPassword - a small,
...
//
// Run: node --test tests/server/verifySignup.test.mjs
// (or via `npm test`, once wired into package.json's test script)

import test from "node:test";
import assert from "node:assert/strict";
import verifySignUp from "../../server/middleware/verifySignup.js";
