...
| File | Purpose |
|---|---|
| `src/production/iot/edge_inference/iot_edge_client.py` | RPi script — records audio, runs TFLite, publishes prediction |
| `src/production/iot/edge_inference/requirements.txt` | RPi Python dependencies |
| `src/production/iot/edge_inference/README.md` | This file |
