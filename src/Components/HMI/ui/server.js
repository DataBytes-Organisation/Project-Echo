...
const url = `mongodb://${process.env.DB_USER}:${process.env.DB_USER_PASS}@${process.env.DB_HOST}:27017/EchoNet`;
...
db.mongoose
  .connect(
    `mongodb://${process.env.DB_ROOT_USER}:${process.env.DB_ROOT_USER_PASS}@${process.env.DB_HOST}/UserSample?authSource=admin`,
    {
