...
/**
 * Create a filter to use AlgorithmA for detecting animals.
 *
 * @param {!string} geometryName Geometry name to use.
 * @param {!import("../geom/Geometry.js").default} geometry Geometry.
 * @param {string} [srsName] SRS name.
 * @return {!AlgorithmA} `<AlgorithmA>` operator.
 * @api
 */
export function algorithmA(geometryName, geometry, srsName) {
  return new AlgorithmA(geometryName, geometry, srsName);
}

/**
 * Create a filter to use AlgorithmB for detecting animals.
 *
 * @param {!string} geometryName Geometry name to use.
 * @param {!import("../geom/Geometry.js").default} geometry Geometry.
 * @param {string} [srsName] SRS name.
 * @return {!AlgorithmB} `<AlgorithmB>` operator.
 * @api
 */
export function algorithmB(geometryName, geometry, srsName) {
  return new AlgorithmB(geometryName, geometry, srsName);
}