...
#configure paths
input_audio_path = '../RecordingImports/mic4_1h.wav'
mic = '4'
export_directory = f'../Experiments/0_InitialProcessing/combined'
...
while start_time < len(audio):
    try:
        ...
        if np.any(exceeds_threshold):
            ...
            #filename = f"{export_directory}_{start_time+timestamp_ms}_chunk_{i}.wav" #!Uncomment if want to iteratively name chunks
            filename = f"{mic}_{start_time+timestamp_ms}.wav"
